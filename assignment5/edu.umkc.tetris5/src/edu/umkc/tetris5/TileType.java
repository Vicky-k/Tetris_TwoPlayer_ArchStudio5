...
public enum TileType {
	 ...
	 * Piece TypeI.
	 */
	TypeI(new Color(BoardPanelOne.COLOR_MIN, BoardPanelOne.COLOR_MAX, BoardPanelOne.COLOR_MAX), 4, 4, 1, new boolean[][] {
		{
	 ...
	 * Piece TypeJ.
	 */
	TypeJ(new Color(BoardPanelOne.COLOR_MIN, BoardPanelOne.COLOR_MIN, BoardPanelOne.COLOR_MAX), 3, 3, 2, new boolean[][] {
		{
			true,	false,	false,
			true,	true,	true,
			false,	false,	false,
	 ...
	 * Piece TypeL.
	 */
	TypeL(new Color(BoardPanelOne.COLOR_MAX, 127, BoardPanelOne.COLOR_MIN), 3, 3, 2, new boolean[][] {
		{
			false,	false,	true,
			true,	true,	true,
			false,	false,	false,
	 ...
	 * Piece TypeO.
	 */
	TypeO(new Color(BoardPanelOne.COLOR_MAX, BoardPanelOne.COLOR_MAX, BoardPanelOne.COLOR_MIN), 2, 2, 2, new boolean[][] {
		{
			true,	true,
			true,	true,
		},
	 ...
	 * Piece TypeS.
	 */
	TypeS(new Color(BoardPanelOne.COLOR_MIN, BoardPanelOne.COLOR_MAX, BoardPanelOne.COLOR_MIN), 3, 3, 2, new boolean[][] {
		{
			false,	true,	true,
			true,	true,	false,
			false,	false,	false,
	 ...
	 * Piece TypeT.
	 */
	TypeT(new Color(128, BoardPanelOne.COLOR_MIN, 128), 3, 3, 2, new boolean[][] {
		{
			false,	true,	false,
			true,	true,	true,
			false,	false,	false,
	 ...
	 * Piece TypeZ.
	 */
	TypeZ(new Color(BoardPanelOne.COLOR_MAX, BoardPanelOne.COLOR_MIN, BoardPanelOne.COLOR_MIN), 3, 3, 2, new boolean[][] {
		{
			true,	true,	false,
			false,	true,	true,
			false,	false,	false,
