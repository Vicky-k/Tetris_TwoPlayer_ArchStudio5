...
public class BoardPanelOne extends JPanel{
	 ...
	 */
	public BoardPanelOne(TetrisImp tetris) {
		this.tetris = tetris;
	 ...
	 */
	public int checkLines(BoardPanelTwo boardTwo) {
	 ...
	 */
	public boolean checkLine(int line, BoardPanelTwo boardTwo) {
		/*
		 ...
		 */
		boardTwo.otherPlayer(this, line);
...
public void otherPlayer(BoardPanelTwo boardTwo, int line){
		...
		addlinesindex++;
		for(int col = 0; col < COL_COUNT; col++){
		setTile(col, peak, boardTwo.getTile(col, line));
	}
