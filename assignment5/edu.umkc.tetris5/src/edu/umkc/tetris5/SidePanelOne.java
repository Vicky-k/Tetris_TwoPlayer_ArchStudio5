 ...
 *
 */
public class SidePanelOne extends JPanel{
	/**
	 * Serial Version UID.
	 */
	 ...
	 */
	public static final int TILE_SIZE = BoardPanelOne.TILE_SIZE >> 1;
	
	/**
	 * The width of the shading on each tile on the next piece preview.
	 */
	public static final int SHADE_WIDTH = BoardPanelOne.SHADE_WIDTH >> 1;
	 ...
	 */
	public SidePanelOne(TetrisImp tetris) {
		this.tetris = tetris;
		
		setPreferredSize(new Dimension(200, BoardPanelOne.PANEL_HEIGHT));
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("PLAYER1 GAME",SMALL_INSET, offset = STATS_INSET-30);
