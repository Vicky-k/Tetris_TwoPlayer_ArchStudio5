...
public class SecondPlayerClockImp implements ISecondPlayerClockImp
{
private SecondPlayerClockArch _arch;
    ...
    public SecondPlayerClockImp (){
    }

	public void setArch(SecondPlayerClockArch arch){
		_arch = arch;
	}
	public SecondPlayerClockArch getArch(){
		return _arch;
	}
